...
resource "aws_secretsmanager_secret_version" "application3" {
  ...
  secret_string_wo_version = "terraform-20251216183030347200000001"
 } 
...
resource "aws_secretsmanager_secret_version" "application1" {
  ...
  secret_string_wo_version = "terraform-20251216173132178700000001"
 } 
...
resource "aws_secretsmanager_secret_version" "application2" {
  ...
  secret_string_wo_version = "terraform-20251216173132178700000003"
 } 
...
resource "aws_secretsmanager_secret_version" "application4" {
  ...
  secret_string_wo_version = "terraform-20251216182644578600000002"
 } 
